...
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_ACCEPTED;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_BAD_REQUEST;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_CREATED;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_FORBIDDEN;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_MULTI_STATUS;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_NOT_FOUND;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_NO_CONTENT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_OK;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_PARTIAL_CONTENT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_REQUESTED_RANGE_NOT_SATISFIABLE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_RESET_CONTENT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus.SC_UNAUTHORIZED;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.DEFAULT_SOCKET_TIMEOUT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.DEFAULT_SWIFT_BLOCKSIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.DEFAULT_SWIFT_PARTITION_SIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.DEFAULT_SWIFT_REQUEST_SIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.DEFAULT_THROTTLE_DELAY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_AUTH_KEY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_CONTENT_LENGTH;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_CONTENT_RANGE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_DESTINATION;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_RANGE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.HEADER_USER_AGENT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SERVICE_CATALOG_CLOUD_FILES;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SERVICE_CATALOG_OBJECT_STORE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SERVICE_CATALOG_SWIFT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_APIKEY_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_AUTH_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_BLOCKSIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_CONNECTION_TIMEOUT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_CONTAINER_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_LOCATION_AWARE_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_OBJECT_AUTH_ENDPOINT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_PARTITION_SIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_PASSWORD_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_PROXY_HOST_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_PROXY_PORT_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_PUBLIC_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_RANGE_HEADER_FORMAT_PATTERN;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_REGION_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_REQUEST_SIZE;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_RETRY_COUNT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_SERVICE_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_SOCKET_TIMEOUT;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_TENANT_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_THROTTLE_DELAY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_USERNAME_PROPERTY;
import static org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.http.SwiftProtocolConstants.SWIFT_USER_AGENT;
...
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.DefaultHttpMethodRetryHandler;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.Header;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpClient;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpHost;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpMethodBase;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.HttpStatus;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.DeleteMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.GetMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.HeadMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.InputStreamRequestEntity;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.PostMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.PutMethod;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.methods.StringRequestEntity;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.params.HttpConnectionParams;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.commons.httpclient.params.HttpMethodParams;
...
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.ApiKeyAuthenticationRequest;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.ApiKeyCredentials;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.AuthenticationRequest;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.AuthenticationRequestWrapper;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.AuthenticationResponse;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.AuthenticationWrapper;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.KeyStoneAuthRequest;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.KeystoneApiKeyCredentials;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.PasswordAuthenticationRequest;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.PasswordCredentials;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.entities.AccessToken;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.entities.Catalog;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.auth.entities.Endpoint;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftAuthenticationFailedException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftBadRequestException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftConfigurationException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftInternalStateException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftInvalidResponseException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.exceptions.SwiftThrottledRequestException;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.util.Duration;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.util.DurationStats;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.util.DurationStatsTable;
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.hadoop.fs.swift.util.JSONUtil;
...
import org.apache.flink.fs.openstackhadoop.shaded.org.apache.http.conn.params.ConnRoutePNames;
...
public final class SwiftRestClientTempAuth {
  private static final Log LOG = LogFactory.getLog(SwiftRestClientTempAuth.class);
  ...
  * the name of a proxy host (can be null, in which case there is no proxy)
  ...
  private static class AuthGetMethod extends GetMethod {
    public AuthGetMethod(String uri) {
      super(uri);
    }
  }


  private static abstract class TempAuthMethodProcessor<R> extends
      HttpMethodProcessor<AuthGetMethod, R> {
    @Override
    protected AuthGetMethod doCreateMethod(String uri) {
   ...
   */
  private SwiftRestClientTempAuth(URI filesystemURI,
                          Configuration conf)
  ...
  public AccessToken authenticate() throws IOException {
    ...
    if (apiKeyCredentials != null) {
      ...
      headers.put("X-Storage-User", apiKeyCredentials.getUsername());
      headers.put("X-Storage-Pass", apiKeyCredentials.getApiKey());
      return perform("authentication", authUri, headers, new AuthenticationV1Get(authenticationRequest));
    }
  ...
  private class AuthenticationV1Get extends TempAuthMethodProcessor<AccessToken> {
    final AuthenticationRequest authenticationRequest;
    public AuthenticationV1Get(AuthenticationRequest authenticationRequest) {
    ...
    public AccessToken extractResult(AuthGetMethod method) throws IOException {
      ...
      if (method.getStatusCode() == SC_BAD_REQUEST) {
        throw new SwiftAuthenticationFailedException(
            authenticationRequest.toString(), "GET", authUri, method);
      }

      AccessToken accessToken = new AccessToken();

      accessToken.setExpires(extractHeaderValue(method, "x-auth-token-expires"));
      accessToken.setId(extractHeaderValue(method,SwiftProtocolConstants.HEADER_AUTH_KEY));
      token = accessToken;
      ...
      try {
        endpointURI = new URI(extractHeaderValue(method, "x-storage-url"));
      } catch (URISyntaxException e) {
        throw  new SwiftException(e);
      }
      String path = "/v1/" + username + "/" + container;
  ...
  private String extractHeaderValue(AuthGetMethod method, String headerName) throws SwiftException {
    Header header = method.getResponseHeader(headerName);
    if (header != null) {
      return header.getValue();
    } else {
      throw new SwiftException("Header not in the response, name: " + headerName);
    }
  }
  ...
  private <M extends HttpMethod, R> R perform(String reason,
    ...
    return perform(reason, uri, emptyMap(), processor);
  }
  ...
  private <M extends HttpMethod, R> R perform(String reason,
    ...
    headers.forEach(method::addRequestHeader);
   ...
   */
  public static SwiftRestClientTempAuth getInstance(URI filesystemURI,
                            Configuration config) throws IOException {
    return new SwiftRestClientTempAuth(filesystemURI, config);
  }
